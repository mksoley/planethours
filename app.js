...
const I18N={
  tr:{ appTitle:"Gezegen Saatleri Dua Aracı", appSummary:"Otomatik konum, 100+ şehir, en yakın & en ideal dua saati",
      ...
      purposeHint:"Tablodaki Dua Amacı sütununa tıklayarak her gezegen saatinde ne için dua edebileceğinize dair ayrıntılı rehbere ulaşabilirsiniz.",
      purposeHintBadge:"👆 Tıkla"
  },
  en:{ appTitle:"Planetary Prayer Hours", appSummary:"Auto location, 100+ cities, nearest & most ideal time",
      ...
      purposeHint:"Click any cell in the Prayer Purpose column to open a detailed guide on what to pray for during that planetary hour.",
      purposeHintBadge:"👆 Tap"
  }
};
...
function applyI18n(){ const titleEl=document.getElementById("appTitle"); const titleSpan=titleEl.querySelector("span"); if(titleSpan){titleSpan.textContent=t("appTitle");}else{titleEl.textContent=t("appTitle");} document.getElementById("appSummary").textContent = t("appSummary"); document.getElementById("thIdx").textContent = t("thIdx"); document.getElementById("thStart").textContent = t("thStart"); document.getElementById("thEnd").textContent = t("thEnd"); document.getElementById("thPlanet").textContent = t("thPlanet"); document.getElementById("thSegment").textContent = t("thSegment"); document.getElementById("thPurpose").textContent = t("thPurpose"); document.getElementById("bestHeader").textContent = t("bestHeader"); document.getElementById("testsHeader").textContent = t("testsHeader"); document.getElementById("note").textContent = t("note"); document.getElementById("footerLine").textContent = t("footerLine"); document.getElementById("refsTitle").textContent = t("refsTitle"); document.getElementById("customCityTitle").textContent = t("customCityTitle"); document.getElementById("customCityHelp").textContent = t("customCityHelp"); document.getElementById("citySearch").placeholder = t("searchPlaceholder"); document.getElementById("icsBtn").textContent = t("icsBtn"); const hintEl=document.getElementById("purposeHintText"); if(hintEl){ hintEl.innerHTML=`Tablodaki <strong>${t("thPurpose")}</strong> ${currentLang()==="tr"?"sütununa tıklayarak her gezegen saatinde ne için dua edebileceğinize dair ayrıntılı rehbere ulaşabilirsiniz.":"column — click any cell to open a detailed guide on what to pray for during that planetary hour."}`; } const badgeEl=document.getElementById("purposeHintBadge"); if(badgeEl) badgeEl.textContent=t("purposeHintBadge"); setRTLIfNeeded(); }
