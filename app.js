...
function render(){
  ...
  document.getElementById("title").textContent=`${t("today")} — ${todayStr} (${city.tz})`;
  document.getElementById("sunline").textContent=`${t("sunrise")}: ${formatInTZ(sunrise,city.tz,{hour:"2-digit",minute:"2-digit"})}, ${t("solarnoon")}: ${formatInTZ(solarNoon,city.tz,{hour:"2-digit",minute:"2-digit"})}, ${t("sunset")}: ${formatInTZ(sunset,city.tz,{hour:"2-digit",minute:"2-digit"})}`;
